...

{
 ...
 for (int i = 0; i <=34; ++i)
 {
 	if(i == 5||i==6||i==7||i==10||i==11||i==12||i==14||i==15||i==16||i==18||i==19||i==20||i==22||i==23||i==24){
 		cout << ch;
 	}else{
 		cout << " ";
 	}
 ...
 cout << endl;
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==7||i==10||i==12||i==15||i==19||i==23){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
 	...
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==6||i==7||i==10||i==12||i==15||i==19||i==23){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
 	...
 	for (int i = 0; i <=34; ++i)
	{
 	...
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==7||i==10||i==11||i==12||i==14||i==15||i==16||i==19||i==22||i==23||i==24){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
