...

{
 ...
 for (int i = 0; i <=34; ++i)
 {
 	if(i == 5||i==6||i==7||i==9||i==10||i==11||i==13||i==14||i==15||i==17||i==18||i==19||i==21||i==22||i==23||i==25||i==26||i==27){
 		cout << ch;
 	}else{
 		cout << " ";
 	}
 ...
 cout << endl;
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==7||i==10||i==13||i==15||i==18||i==22||i==26){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
 	...
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==6||i==7||i==10||i==13||i==15||i==18||i==22||i==26){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
 	...
 	for (int i = 0; i <=34; ++i)
	{
 	...
 	for (int i = 0; i <=34; ++i)
	{
 		if(i == 5||i==7||i==9||i==10||i==11||i==13||i==14||i==15||i==17||i==18||i==19||i==22||i==25||i==26||i==27){
 			cout << ch;
 		}else{
 			cout << " ";
 		}
